// FMC-AM 6F · Motor v4.2 — fmc-engine.js — build: v4.2-b20260316-tap8
...
const TAP_PARAM_MAP = {
  ...
  // ── IDs do dump7 (fábrica) — escalas por família ─────────────
  // Delays 0x08xx: raw=5, escala=8.0ms (delay genérico)
  0x080B:({raw:5, tipo:'ms', escala:8.0}),
  0x080C:({raw:5, tipo:'ms', escala:8.0}),
  0x080D:({raw:5, tipo:'ms', escala:8.0}),
  0x0860:({raw:5, tipo:'ms', escala:8.0}),
  0x0865:({raw:3, tipo:'ms', escala:25.4}),   // LongDly (MUSEUM) raw=3 confirmado   // ← Dly65 (MUSEUM)
  0x0869:({raw:5, tipo:'ms', escala:8.0}),
  0x0873:({raw:5, tipo:'ms', escala:8.0}),
  // Delays 0x28xx: raw=5, escala=8.0ms
  0x2802:({raw:5, tipo:'ms', escala:8.0}),
  0x2808:({raw:5, tipo:'ms', escala:8.0}),
  0x280A:({raw:5, tipo:'ms', escala:8.0}),
  0x280C:({raw:5, tipo:'ms', escala:8.0}),
  0x2813:({raw:5, tipo:'ms', escala:8.0}),
  0x282E:({raw:5, tipo:'ms', escala:8.0}),
  0x283B:({raw:5, tipo:'ms', escala:8.0}),
  0x2852:({raw:5, tipo:'ms', escala:8.0}),
  0x2855:({raw:5, tipo:'ms', escala:8.0}),
  0x285A:({raw:5, tipo:'ms', escala:8.0}),
  0x285D:({raw:5, tipo:'ms', escala:8.0}),
  0x2868:({raw:5, tipo:'ms', escala:8.0}),
  0x2869:({raw:5, tipo:'ms', escala:8.0}),
  0x286A:({raw:5, tipo:'ms', escala:8.0}),
  0x2873:({raw:5, tipo:'ms', escala:8.0}),
  0x2874:({raw:5, tipo:'ms', escala:8.0}),
  // Mods 0x06xx: raw=6, escala=25.0hz (família Chorus)
  0x0602:({raw:2, tipo:'hz', escala:12.0}),   // Phaser (A6 PhasrFk confirmado)
  0x0604:({raw:6, tipo:'hz', escala:25.0}),
  0x0606:({raw:6, tipo:'hz', escala:25.0}),
  0x0608:({raw:6, tipo:'hz', escala:25.0}),
  0x0609:({raw:6, tipo:'hz', escala:25.0}),
  0x060D:({raw:6, tipo:'hz', escala:25.0}),
  0x060F:({raw:6, tipo:'hz', escala:25.0}),
  0x0611:({raw:6, tipo:'hz', escala:25.0}),
  0x0613:({raw:6, tipo:'hz', escala:25.0}),
  // Mods 0x26xx: raw=2, escala=12.0hz (família Phaser)
  0x2601:({raw:2, tipo:'hz', escala:12.0}),
  0x2603:({raw:2, tipo:'hz', escala:12.0}),
  0x2607:({raw:2, tipo:'hz', escala:12.0}),
  0x260A:({raw:2, tipo:'hz', escala:12.0}),
  0x260D:({raw:2, tipo:'hz', escala:12.0}),
  0x2613:({raw:2, tipo:'hz', escala:12.0}),
...
function enviarSysExTapTempo(bpm){
  ...
  sysexIdleTimer = setTimeout(async()=>{
    ...
    if(false){  // removido: tap agora injeta independente de enabled
    ...
    for(const efeito of efeitosAlvo){
      ...
      try{
        ...
        enviados.push(`${efeito.nome}@S${slotIdx+1}r${rawIdx}→${val}`);
