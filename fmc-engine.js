// FMC-AM 6F · Motor v4.2 — fmc-engine.js — build: v4.2-b20260316-dump7
...
const PATCH_CACHE_SEED = {
  'A0':{nome:'MUSEUM',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:259,nome:'Dyn03',cat:'dynamics',tap:null,enabled:false},{slot:2,id:771,nome:'Drv03',cat:'drive',tap:null,enabled:false},{slot:3,id:2149,nome:'Dly65',cat:'delay',tap:'Time',enabled:false},{slot:4,id:9220,nome:'Amp04b',cat:'amp',tap:null,enabled:false}],ts:0},
  'A1':{nome:'pDuermee',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:2163,nome:'Dly73',cat:'delay',tap:'Time',enabled:false},{slot:2,id:1540,nome:'Mod04',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:10503,nome:'Rvb07b',cat:'reverb',tap:null,enabled:false}],ts:0},
  'A2':{nome:'Blue Ld',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:false},{slot:2,id:9227,nome:'BGDrive',cat:'amp',tap:null,enabled:false},{slot:3,id:2307,nome:'EarlyRef',cat:'reverb',tap:null,enabled:false}],ts:0},
  'A3':{nome:'(AUTOWA',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8707,nome:'Flt03b',cat:'filter',tap:null,enabled:true},{slot:2,id:1044,nome:'MSDrive',cat:'amp',tap:null,enabled:false},{slot:3,id:2305,nome:'Rvb01',cat:'reverb',tap:null,enabled:false}],ts:0},
  'A4':{nome:'Down Hv',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'NoiseGate',cat:'dynamics',tap:null,enabled:false},{slot:2,id:1040,nome:'REVO1',cat:'amp',tap:null,enabled:false}],ts:0},
  'A5':{nome:'Chorusad',volume:100,temTime:true,temRate:false,efeitos:[{slot:1,id:10356,nome:'Dly74b',cat:'delay',tap:'Time',enabled:true},{slot:2,id:10336,nome:'CarbonDly',cat:'delay',tap:'Time',enabled:true},{slot:3,id:10511,nome:'Rvb0Fb',cat:'reverb',tap:null,enabled:false},{slot:4,id:1556,nome:'Tremolo',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'A6':{nome:'PhasrFk',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:257,nome:'Comp',cat:'dynamics',tap:null,enabled:true},{slot:2,id:1538,nome:'Mod02',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:9226,nome:'Amp0Ab',cat:'amp',tap:null,enabled:false},{slot:4,id:2306,nome:'Plate',cat:'reverb',tap:null,enabled:false}],ts:0},
  'A7':{nome:'Jazzy ea',volume:70,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:true},{slot:2,id:777,nome:'Drv09',cat:'drive',tap:null,enabled:false},{slot:3,id:2306,nome:'Plate',cat:'reverb',tap:null,enabled:false}],ts:0},
  'A8':{nome:'pAcoust',volume:75,temTime:false,temRate:false,efeitos:[{slot:1,id:516,nome:'Flt04',cat:'filter',tap:null,enabled:true},{slot:2,id:8976,nome:'Drv10b',cat:'drive',tap:null,enabled:false},{slot:3,id:2324,nome:'HDHall',cat:'reverb',tap:null,enabled:false},{slot:4,id:258,nome:'Dyn02',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'A9':{nome:'Supern',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:9229,nome:'TWRock',cat:'amp',tap:null,enabled:false},{slot:2,id:2319,nome:'Rvb0F',cat:'reverb',tap:null,enabled:false}],ts:0},
  'B0':{nome:'CLEAN',volume:84,temTime:false,temRate:false,efeitos:[{slot:1,id:9221,nome:'Amp05b',cat:'amp',tap:null,enabled:true},{slot:2,id:2309,nome:'Rvb05',cat:'reverb',tap:null,enabled:true},{slot:3,id:266,nome:'Dyn0A',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'B1':{nome:'`CORONA',volume:100,temTime:false,temRate:true,efeitos:[{slot:1,id:9738,nome:'Mod0Ab',cat:'mod',tap:'Rate',enabled:true},{slot:2,id:9220,nome:'Amp04b',cat:'amp',tap:null,enabled:true},{slot:3,id:10333,nome:'Dly5Db',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'B2':{nome:'STRATT',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:266,nome:'Dyn0A',cat:'dynamics',tap:null,enabled:true},{slot:2,id:2311,nome:'Rvb07',cat:'reverb',tap:null,enabled:true}],ts:0},
  'B3':{nome:'xClean p',volume:70,temTime:false,temRate:true,efeitos:[{slot:1,id:788,nome:'Amp',cat:'amp',tap:null,enabled:false},{slot:2,id:1556,nome:'StereCho',cat:'mod',tap:'Rate',enabled:true},{slot:3,id:10251,nome:'Delay',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'B4':{nome:'Just Fk',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:257,nome:'Comp',cat:'dynamics',tap:null,enabled:true},{slot:2,id:1034,nome:'Amp0A',cat:'amp',tap:null,enabled:false},{slot:3,id:10500,nome:'TiledRoom',cat:'reverb',tap:null,enabled:false}],ts:0},
  'B5':{nome:'CrystaVi',volume:100,temTime:true,temRate:false,efeitos:[{slot:1,id:10344,nome:'Dly68b',cat:'delay',tap:'Time',enabled:true},{slot:2,id:10503,nome:'Rvb07b',cat:'reverb',tap:null,enabled:true},{slot:3,id:10504,nome:'Spring63',cat:'reverb',tap:null,enabled:false},{slot:4,id:1542,nome:'Mod06',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'B6':{nome:'Pic Ch',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:false},{slot:2,id:2059,nome:'Dly0B',cat:'delay',tap:'Time',enabled:false},{slot:3,id:2306,nome:'Plate',cat:'reverb',tap:null,enabled:false}],ts:0},
  'B7':{nome:'Rev Drm',volume:70,temTime:false,temRate:false,efeitos:[{slot:1,id:1033,nome:'Amp09',cat:'amp',tap:null,enabled:false},{slot:2,id:2321,nome:'Rvb11',cat:'reverb',tap:null,enabled:true}],ts:0},
  'B8':{nome:'TapeSl',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:10259,nome:'Dly13b',cat:'delay',tap:'Time',enabled:false},{slot:2,id:1030,nome:'FDCombo',cat:'amp',tap:null,enabled:true}],ts:0},
  'B9':{nome:'Funky uc',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:516,nome:'Flt04',cat:'filter',tap:null,enabled:false},{slot:2,id:1545,nome:'Mod09',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'C0':{nome:'`Big Ra',volume:65,temTime:false,temRate:false,efeitos:[{slot:1,id:261,nome:'SlowAtck',cat:'filter',tap:null,enabled:true},{slot:2,id:9736,nome:'Detune',cat:'pitch',tap:null,enabled:true},{slot:3,id:9735,nome:'Mod07b',cat:'mod',tap:'Rate',enabled:false},{slot:4,id:10345,nome:'Dly69b',cat:'delay',tap:'Time',enabled:false},{slot:5,id:2304,nome:'Rvb00',cat:'reverb',tap:null,enabled:false}],ts:0},
  'C1':{nome:'RAKE',volume:85,temTime:false,temRate:false,efeitos:[{slot:1,id:1028,nome:'Amp04',cat:'amp',tap:null,enabled:true},{slot:2,id:8705,nome:'fCycle',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:265,nome:'160Comp',cat:'dynamics',tap:null,enabled:false},{slot:4,id:10506,nome:'Rvb0Ab',cat:'reverb',tap:null,enabled:false}],ts:0},
  'C2':{nome:'TRIPY',volume:60,temTime:false,temRate:false,efeitos:[{slot:1,id:9223,nome:'VXCombo',cat:'amp',tap:null,enabled:true},{slot:2,id:1555,nome:'Mod13',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:10252,nome:'Dly0Cb',cat:'delay',tap:'Time',enabled:false},{slot:4,id:9731,nome:'Mod03b',cat:'mod',tap:'Rate',enabled:false},{slot:5,id:10497,nome:'Rvb01b',cat:'reverb',tap:null,enabled:false}],ts:0},
  'C3':{nome:'ACO',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'ZNR',cat:'dynamics',tap:null,enabled:true},{slot:2,id:788,nome:'Amp',cat:'amp',tap:null,enabled:false},{slot:3,id:8460,nome:'Dyn0Cb',cat:'dynamics',tap:null,enabled:false},{slot:4,id:2317,nome:'Rvb0D',cat:'reverb',tap:null,enabled:false}],ts:0},
  'C4':{nome:'StRahh',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8983,nome:'Drv17b',cat:'drive',tap:null,enabled:true},{slot:2,id:8454,nome:'Dyn06b',cat:'dynamics',tap:null,enabled:true},{slot:3,id:2315,nome:'Rvb0B',cat:'reverb',tap:null,enabled:false},{slot:4,id:9731,nome:'Mod03b',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'C5':{nome:'Natura',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1030,nome:'FDCombo',cat:'amp',tap:null,enabled:false},{slot:2,id:10498,nome:'Hall',cat:'reverb',tap:null,enabled:false}],ts:0},
  'C6':{nome:'SPAGHETI',volume:100,temTime:false,temRate:true,efeitos:[{slot:1,id:1553,nome:'Mod11',cat:'mod',tap:'Rate',enabled:true},{slot:2,id:1029,nome:'Amp05',cat:'amp',tap:null,enabled:true},{slot:3,id:10502,nome:'Rvb06b',cat:'reverb',tap:null,enabled:false}],ts:0},
  'C7':{nome:'Gardenok',volume:70,temTime:false,temRate:false,efeitos:[{slot:1,id:8961,nome:'Drv01b',cat:'drive',tap:null,enabled:true},{slot:2,id:1028,nome:'Amp04',cat:'amp',tap:null,enabled:false},{slot:3,id:2304,nome:'Rvb00',cat:'reverb',tap:null,enabled:false}],ts:0},
  'C8':{nome:'CleanJz',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:269,nome:'Dyn0D',cat:'dynamics',tap:null,enabled:true},{slot:2,id:516,nome:'Flt04',cat:'filter',tap:null,enabled:false},{slot:3,id:1029,nome:'Amp05',cat:'amp',tap:null,enabled:false},{slot:4,id:10242,nome:'Dly02b',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'C9':{nome:'YELLOW12',volume:70,temTime:false,temRate:true,efeitos:[{slot:1,id:9222,nome:'Amp06b',cat:'amp',tap:null,enabled:true},{slot:2,id:1542,nome:'Mod06',cat:'mod',tap:'Rate',enabled:true},{slot:3,id:265,nome:'160Comp',cat:'dynamics',tap:null,enabled:false},{slot:4,id:2319,nome:'Rvb0F',cat:'reverb',tap:null,enabled:false}],ts:0},
  'D0':{nome:'BritCoo',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:9228,nome:'CARDrive',cat:'amp',tap:null,enabled:true},{slot:2,id:785,nome:'Fuzz',cat:'drive',tap:null,enabled:false},{slot:3,id:513,nome:'Cry',cat:'filter',tap:null,enabled:false},{slot:4,id:8456,nome:'Dyn08b',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'D1':{nome:'OJ',volume:70,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'ZNR',cat:'dynamics',tap:null,enabled:false},{slot:2,id:1038,nome:'FDVibro',cat:'amp',tap:null,enabled:false},{slot:3,id:2144,nome:'Dly60',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'D2':{nome:'Talk Fk',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:8704,nome:'Flt00b',cat:'filter',tap:null,enabled:true},{slot:2,id:770,nome:'Drv02',cat:'drive',tap:null,enabled:false},{slot:3,id:10497,nome:'Rvb01b',cat:'reverb',tap:null,enabled:false}],ts:0},
  'D3':{nome:'MS STA',volume:76,temTime:false,temRate:false,efeitos:[{slot:1,id:9230,nome:'BGCrunch',cat:'amp',tap:null,enabled:true},{slot:2,id:8705,nome:'fCycle',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:8457,nome:'Dyn09b',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'D4':{nome:'80s Rhhm',volume:50,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false},{slot:2,id:1556,nome:'Tremolo',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:10505,nome:'Rvb09b',cat:'reverb',tap:null,enabled:false}],ts:0},
  'D5':{nome:'REC.PO',volume:83,temTime:false,temRate:true,efeitos:[{slot:1,id:8450,nome:'ZNR',cat:'dynamics',tap:null,enabled:false},{slot:2,id:2313,nome:'ModReverb',cat:'reverb',tap:'Rate',enabled:true},{slot:3,id:9231,nome:'BlackBrth',cat:'amp',tap:null,enabled:false}],ts:0},
  'D6':{nome:'FAT RHHM',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:9235,nome:'Amp13b',cat:'amp',tap:null,enabled:true},{slot:2,id:8705,nome:'fCycle',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:8457,nome:'Dyn09b',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'D7':{nome:'KRAVIT',volume:67,temTime:false,temRate:true,efeitos:[{slot:1,id:1549,nome:'Mod0D',cat:'mod',tap:'Rate',enabled:true},{slot:2,id:774,nome:'Drv06',cat:'drive',tap:null,enabled:false},{slot:3,id:9234,nome:'Amp12b',cat:'amp',tap:null,enabled:false}],ts:0},
  'D8':{nome:'Tap Deay',volume:64,temTime:false,temRate:false,efeitos:[{slot:1,id:1041,nome:'Tangerine',cat:'amp',tap:null,enabled:true},{slot:2,id:10345,nome:'Dly69b',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'D9':{nome:'GIRL',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'NoiseGate',cat:'dynamics',tap:null,enabled:false},{slot:2,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false},{slot:3,id:10497,nome:'Rvb01b',cat:'reverb',tap:null,enabled:false},{slot:4,id:1029,nome:'Amp05',cat:'amp',tap:null,enabled:false},{slot:5,id:256,nome:'Dyn00',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'E0':{nome:'SURF',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false},{slot:2,id:2311,nome:'Rvb07',cat:'reverb',tap:null,enabled:false},{slot:3,id:1032,nome:'Amp08',cat:'amp',tap:null,enabled:false}],ts:0},
  'E1':{nome:'CLASSI',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:770,nome:'Drv02',cat:'drive',tap:null,enabled:true},{slot:2,id:1028,nome:'Amp04',cat:'amp',tap:null,enabled:false},{slot:3,id:2153,nome:'Dly69',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'E2':{nome:'B.SESSN',volume:70,temTime:true,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false},{slot:2,id:10250,nome:'Dly0Ab',cat:'delay',tap:'Time',enabled:true},{slot:3,id:1038,nome:'FDVibro',cat:'amp',tap:null,enabled:false}],ts:0},
  'E3':{nome:'YORKE',volume:62,temTime:false,temRate:false,efeitos:[{slot:1,id:774,nome:'Drv06',cat:'drive',tap:null,enabled:false},{slot:2,id:9741,nome:'Mod0Db',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:10336,nome:'CarbonDly',cat:'delay',tap:'Time',enabled:false},{slot:4,id:10498,nome:'Room',cat:'reverb',tap:null,enabled:false},{slot:5,id:1031,nome:'Matchless',cat:'amp',tap:null,enabled:false}],ts:0},
  'E4':{nome:'SIMPLEON',volume:87,temTime:true,temRate:false,efeitos:[{slot:1,id:1036,nome:'Deluxe',cat:'amp',tap:null,enabled:true},{slot:2,id:10299,nome:'Dly3Bb',cat:'delay',tap:'Time',enabled:true},{slot:3,id:8980,nome:'Drv14b',cat:'drive',tap:null,enabled:false}],ts:0},
  'E5':{nome:'FunkRoar',volume:100,temTime:false,temRate:true,efeitos:[{slot:1,id:1544,nome:'Mod08',cat:'mod',tap:'Rate',enabled:true},{slot:2,id:8708,nome:'AutoWah',cat:'filter',tap:null,enabled:false},{slot:3,id:9220,nome:'Amp04b',cat:'amp',tap:null,enabled:false},{slot:4,id:8707,nome:'Flt03b',cat:'filter',tap:null,enabled:false},{slot:5,id:9995,nome:'Spc0Bb',cat:'special',tap:null,enabled:false}],ts:0},
  'E6':{nome:'WHITE',volume:80,temTime:true,temRate:false,efeitos:[{slot:1,id:774,nome:'Drv06',cat:'drive',tap:null,enabled:true},{slot:2,id:10330,nome:'Dly5Ab',cat:'delay',tap:'Time',enabled:true},{slot:3,id:10504,nome:'Spring63',cat:'reverb',tap:null,enabled:false},{slot:4,id:1030,nome:'FDCombo',cat:'amp',tap:null,enabled:false}],ts:0},
  'E7':{nome:'ORG CRC',volume:90,temTime:false,temRate:false,efeitos:[{slot:1,id:1037,nome:'HWStar',cat:'amp',tap:null,enabled:true},{slot:2,id:8961,nome:'Drv01b',cat:'drive',tap:null,enabled:false},{slot:3,id:513,nome:'Cry',cat:'filter',tap:null,enabled:false},{slot:4,id:265,nome:'160Comp',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'E8':{nome:'VALENTE',volume:60,temTime:false,temRate:false,efeitos:[{slot:1,id:267,nome:'Dyn0B',cat:'dynamics',tap:null,enabled:false},{slot:2,id:773,nome:'Drv05',cat:'drive',tap:null,enabled:false},{slot:3,id:1030,nome:'FDCombo',cat:'amp',tap:null,enabled:false}],ts:0},
  'E9':{nome:'FILTER',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:2061,nome:'Dly0D',cat:'delay',tap:'Time',enabled:false},{slot:2,id:9220,nome:'Amp04b',cat:'amp',tap:null,enabled:false},{slot:3,id:2061,nome:'Dly0D',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'F0':{nome:'METAL IF',volume:110,temTime:false,temRate:false,efeitos:[{slot:1,id:773,nome:'Drv05',cat:'drive',tap:null,enabled:true},{slot:2,id:9231,nome:'BlackBrth',cat:'amp',tap:null,enabled:false},{slot:3,id:262,nome:'Dyn06',cat:'dynamics',tap:null,enabled:false},{slot:4,id:8705,nome:'fCycle',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'F1':{nome:'Wilhel',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:8976,nome:'Drv10b',cat:'drive',tap:null,enabled:false},{slot:2,id:1032,nome:'Amp08',cat:'amp',tap:null,enabled:false},{slot:3,id:10498,nome:'Hall',cat:'reverb',tap:null,enabled:false}],ts:0},
  'F2':{nome:'MUFFBI',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1039,nome:'ALIEN',cat:'amp',tap:null,enabled:true},{slot:2,id:8963,nome:'Drv03b',cat:'drive',tap:null,enabled:false},{slot:3,id:8705,nome:'fCycle',cat:'mod',tap:'Rate',enabled:false},{slot:4,id:263,nome:'Dyn07',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'F3':{nome:'Dr.Roc',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:9228,nome:'CARDrive',cat:'amp',tap:null,enabled:true},{slot:2,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:false},{slot:3,id:8707,nome:'Flt03b',cat:'filter',tap:null,enabled:false},{slot:4,id:257,nome:'Comp',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'F4':{nome:'Miracl',volume:50,temTime:false,temRate:false,efeitos:[{slot:1,id:9238,nome:'Amp16b',cat:'amp',tap:null,enabled:true},{slot:2,id:1540,nome:'Mod04',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:10498,nome:'Room',cat:'reverb',tap:null,enabled:false}],ts:0},
  'F5':{nome:'MODERNHVY',volume:96,temTime:false,temRate:false,efeitos:[{slot:1,id:9234,nome:'Amp12b',cat:'amp',tap:null,enabled:false},{slot:2,id:8453,nome:'Dyn05b',cat:'dynamics',tap:null,enabled:false},{slot:3,id:8705,nome:'fCycle',cat:'mod',tap:'Rate',enabled:false},{slot:4,id:8457,nome:'Dyn09b',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'F6':{nome:'Gilmouih',volume:100,temTime:true,temRate:false,efeitos:[{slot:1,id:778,nome:'Squeak',cat:'drive',tap:null,enabled:true},{slot:2,id:10346,nome:'Dly6Ab',cat:'delay',tap:'Time',enabled:true},{slot:3,id:2306,nome:'Plate',cat:'reverb',tap:null,enabled:false}],ts:0},
  'F7':{nome:'FOOFIGT',volume:73,temTime:false,temRate:true,efeitos:[{slot:1,id:9730,nome:'Phaser',cat:'mod',tap:'Rate',enabled:true},{slot:2,id:8450,nome:'ZNR',cat:'dynamics',tap:null,enabled:false},{slot:3,id:1031,nome:'Matchless',cat:'amp',tap:null,enabled:false}],ts:0},
  'F8':{nome:'JIMI',volume:70,temTime:false,temRate:false,efeitos:[{slot:1,id:8969,nome:'Drv09b',cat:'drive',tap:null,enabled:false},{slot:2,id:9736,nome:'Detune',cat:'pitch',tap:null,enabled:false},{slot:3,id:10251,nome:'Delay',cat:'delay',tap:'Time',enabled:false},{slot:4,id:9234,nome:'Amp12b',cat:'amp',tap:null,enabled:false}],ts:0},
  'F9':{nome:'SpeedMa',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'ZNR',cat:'dynamics',tap:null,enabled:false},{slot:2,id:8708,nome:'AutoWah',cat:'filter',tap:null,enabled:false},{slot:3,id:9233,nome:'Amp11b',cat:'amp',tap:null,enabled:false},{slot:4,id:8707,nome:'Flt03b',cat:'filter',tap:null,enabled:false}],ts:0},
  'G0':{nome:'Green I',volume:40,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'ZNR',cat:'dynamics',tap:null,enabled:false},{slot:2,id:769,nome:'Drv01',cat:'drive',tap:null,enabled:false},{slot:3,id:1040,nome:'REVO1',cat:'amp',tap:null,enabled:false},{slot:4,id:1556,nome:'Tremolo',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'G1':{nome:'LA Met',volume:90,temTime:false,temRate:false,efeitos:[{slot:1,id:768,nome:'Drv00',cat:'drive',tap:null,enabled:false},{slot:2,id:772,nome:'Drv04',cat:'drive',tap:null,enabled:false},{slot:3,id:1029,nome:'Amp05',cat:'amp',tap:null,enabled:false},{slot:4,id:10251,nome:'Delay',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'G2':{nome:'Shred ick',volume:62,temTime:false,temRate:false,efeitos:[{slot:1,id:8975,nome:'Drv0Fb',cat:'drive',tap:null,enabled:false},{slot:2,id:1039,nome:'ALIEN',cat:'amp',tap:null,enabled:false},{slot:3,id:10251,nome:'Delay',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'G3':{nome:'Dist Hl',volume:65,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'NoiseGate',cat:'dynamics',tap:null,enabled:false},{slot:2,id:1036,nome:'Deluxe',cat:'amp',tap:null,enabled:true},{slot:3,id:8706,nome:'Flt02b',cat:'filter',tap:null,enabled:false}],ts:0},
  'G4':{nome:'MASSIVL',volume:90,temTime:false,temRate:false,efeitos:[{slot:1,id:1029,nome:'Amp05',cat:'amp',tap:null,enabled:false},{slot:2,id:514,nome:'ParaEQ',cat:'filter',tap:null,enabled:false},{slot:3,id:264,nome:'Dyn08',cat:'dynamics',tap:null,enabled:false},{slot:4,id:2307,nome:'EarlyRef',cat:'reverb',tap:null,enabled:false}],ts:0},
  'G5':{nome:'MUFFLR',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:780,nome:'Drv0C',cat:'drive',tap:null,enabled:true},{slot:2,id:1031,nome:'Matchless',cat:'amp',tap:null,enabled:false},{slot:3,id:2144,nome:'Dly60',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'G6':{nome:'Tappinero',volume:70,temTime:false,temRate:false,efeitos:[{slot:1,id:768,nome:'Drv00',cat:'drive',tap:null,enabled:false},{slot:2,id:1035,nome:'Amp0B',cat:'amp',tap:null,enabled:false},{slot:3,id:514,nome:'ParaEQ',cat:'filter',tap:null,enabled:false},{slot:4,id:10497,nome:'Rvb01b',cat:'reverb',tap:null,enabled:false}],ts:0},
  'G7':{nome:'OCT GT',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1042,nome:'MSCrunch',cat:'amp',tap:null,enabled:false},{slot:2,id:8705,nome:'fCycle',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:8458,nome:'Dyn0Ab',cat:'dynamics',tap:null,enabled:false},{slot:4,id:10497,nome:'Rvb01b',cat:'reverb',tap:null,enabled:false}],ts:0},
  'G8':{nome:'Legatoero',volume:55,temTime:false,temRate:false,efeitos:[{slot:1,id:265,nome:'160Comp',cat:'dynamics',tap:null,enabled:true},{slot:2,id:777,nome:'Drv09',cat:'drive',tap:null,enabled:false},{slot:3,id:9228,nome:'CARDrive',cat:'amp',tap:null,enabled:false},{slot:4,id:514,nome:'ParaEQ',cat:'filter',tap:null,enabled:false},{slot:5,id:10497,nome:'Rvb01b',cat:'reverb',tap:null,enabled:false}],ts:0},
  'G9':{nome:'XGtSoloim',volume:50,temTime:false,temRate:false,efeitos:[{slot:1,id:8975,nome:'Drv0Fb',cat:'drive',tap:null,enabled:false},{slot:2,id:1039,nome:'ALIEN',cat:'amp',tap:null,enabled:false},{slot:3,id:2060,nome:'Dly0C',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'H0':{nome:'JeanSpic',volume:100,temTime:true,temRate:true,efeitos:[{slot:1,id:2167,nome:'ReverseDL',cat:'delay',tap:'Time',enabled:true},{slot:2,id:1538,nome:'Mod02',cat:'mod',tap:'Rate',enabled:true},{slot:3,id:2313,nome:'ModReverb',cat:'reverb',tap:'Rate',enabled:false},{slot:4,id:1804,nome:'RtCloset',cat:'special',tap:null,enabled:true}],ts:0},
  'H1':{nome:'BassSi',volume:65,temTime:false,temRate:false,efeitos:[{slot:1,id:1536,nome:'MonoPitch',cat:'pitch',tap:null,enabled:false},{slot:2,id:1540,nome:'Mod04',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:257,nome:'Comp',cat:'dynamics',tap:null,enabled:false},{slot:4,id:9233,nome:'Amp11b',cat:'amp',tap:null,enabled:false}],ts:0},
  'H2':{nome:'Harm',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:1041,nome:'Tangerine',cat:'amp',tap:null,enabled:true},{slot:2,id:9729,nome:'Mod01b',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:8705,nome:'fCycle',cat:'mod',tap:'Rate',enabled:false},{slot:4,id:2312,nome:'Rvb08',cat:'reverb',tap:null,enabled:false}],ts:0},
  'H3':{nome:'POGISH',volume:120,temTime:false,temRate:false,efeitos:[{slot:1,id:9732,nome:'PitchSHFT',cat:'pitch',tap:null,enabled:true},{slot:2,id:1029,nome:'Amp05',cat:'amp',tap:null,enabled:false},{slot:3,id:10508,nome:'Rvb0Cb',cat:'reverb',tap:null,enabled:false},{slot:4,id:10251,nome:'Delay',cat:'delay',tap:'Time',enabled:false},{slot:5,id:9734,nome:'CoronaRing',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'H4':{nome:'PartyVla',volume:110,temTime:false,temRate:false,efeitos:[{slot:1,id:2324,nome:'HDHall',cat:'reverb',tap:null,enabled:false},{slot:2,id:263,nome:'Dyn07',cat:'dynamics',tap:null,enabled:false},{slot:3,id:10364,nome:'FilterDly',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'H5':{nome:'Cavern',volume:61,temTime:true,temRate:false,efeitos:[{slot:1,id:10507,nome:'Rvb0Bb',cat:'reverb',tap:null,enabled:true},{slot:2,id:10248,nome:'Dly08b',cat:'delay',tap:'Time',enabled:true},{slot:3,id:9996,nome:'Spc0Cb',cat:'special',tap:null,enabled:false},{slot:4,id:9736,nome:'Detune',cat:'pitch',tap:null,enabled:false}],ts:0},
  'H6':{nome:'PROGRE',volume:115,temTime:false,temRate:false,efeitos:[{slot:1,id:9747,nome:'Mod13b',cat:'mod',tap:'Rate',enabled:false},{slot:2,id:262,nome:'Dyn06',cat:'dynamics',tap:null,enabled:false},{slot:3,id:10510,nome:'Rvb0Eb',cat:'reverb',tap:null,enabled:false}],ts:0},
  'H7':{nome:'ARP ON',volume:70,temTime:false,temRate:false,efeitos:[{slot:1,id:513,nome:'SeqFilter',cat:'filter',tap:null,enabled:true},{slot:2,id:1034,nome:'Amp0A',cat:'amp',tap:null,enabled:false},{slot:3,id:10322,nome:'Dly52b',cat:'delay',tap:'Time',enabled:false},{slot:4,id:2317,nome:'Rvb0D',cat:'reverb',tap:null,enabled:false}],ts:0},
  'H8':{nome:'PartSpe',volume:100,temTime:true,temRate:false,efeitos:[{slot:1,id:2153,nome:'Dly69',cat:'delay',tap:'Time',enabled:true},{slot:2,id:2314,nome:'ParticleR',cat:'reverb',tap:null,enabled:false},{slot:3,id:791,nome:'Drv17',cat:'drive',tap:null,enabled:false}],ts:0},
  'H9':{nome:'SnacMos',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:8449,nome:'OptComp',cat:'dynamics',tap:null,enabled:false},{slot:2,id:780,nome:'Drv0C',cat:'drive',tap:null,enabled:false},{slot:3,id:1548,nome:'SuperCho',cat:'mod',tap:'Rate',enabled:false},{slot:4,id:513,nome:'Cry',cat:'filter',tap:null,enabled:false}],ts:0},
  'I0':{nome:'hComp Cea',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:258,nome:'Dyn02',cat:'dynamics',tap:null,enabled:false},{slot:2,id:9747,nome:'Mod13b',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:1030,nome:'FDCombo',cat:'amp',tap:null,enabled:false}],ts:0},
  'I1':{nome:'@DX CRUC',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:9234,nome:'Amp12b',cat:'amp',tap:null,enabled:false},{slot:2,id:10345,nome:'Dly69b',cat:'delay',tap:'Time',enabled:false},{slot:3,id:10498,nome:'Hall',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I2':{nome:'@TEXAS ON',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:769,nome:'Drv01',cat:'drive',tap:null,enabled:true},{slot:2,id:9230,nome:'BGCrunch',cat:'amp',tap:null,enabled:false},{slot:3,id:2306,nome:'Plate',cat:'reverb',tap:null,enabled:false},{slot:4,id:2306,nome:'Plate',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I3':{nome:'NASHVILE',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:256,nome:'Dyn00',cat:'dynamics',tap:null,enabled:true},{slot:2,id:1034,nome:'Amp0A',cat:'amp',tap:null,enabled:false},{slot:3,id:2306,nome:'Plate',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I4':{nome:'MERSEYET',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1029,nome:'Amp05',cat:'amp',tap:null,enabled:false},{slot:2,id:1548,nome:'SuperCho',cat:'mod',tap:'Rate',enabled:false},{slot:3,id:10497,nome:'Rvb01b',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I5':{nome:'WHITEBUE',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:788,nome:'Amp',cat:'amp',tap:null,enabled:false},{slot:2,id:9235,nome:'Amp13b',cat:'amp',tap:null,enabled:true},{slot:3,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:false},{slot:4,id:10496,nome:'Rvb00b',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I6':{nome:'`BRIGHT',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8984,nome:'Drv18b',cat:'drive',tap:null,enabled:false},{slot:2,id:9233,nome:'Amp11b',cat:'amp',tap:null,enabled:true},{slot:3,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:false},{slot:4,id:10286,nome:'Dly2Eb',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'I7':{nome:'xCA.COMO',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8983,nome:'Drv17b',cat:'drive',tap:null,enabled:false},{slot:2,id:1044,nome:'MSDrive',cat:'amp',tap:null,enabled:false},{slot:3,id:257,nome:'Comp',cat:'dynamics',tap:null,enabled:false},{slot:4,id:10325,nome:'Dly55b',cat:'delay',tap:'Time',enabled:false},{slot:5,id:10498,nome:'Hall',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I8':{nome:'BTQ COO',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:9230,nome:'BGCrunch',cat:'amp',tap:null,enabled:true},{slot:2,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:false},{slot:3,id:2324,nome:'HDHall',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I9':{nome:'ROCK T',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:9225,nome:'Amp09b',cat:'amp',tap:null,enabled:true},{slot:2,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:false},{slot:3,id:10251,nome:'Delay',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'J0':{nome:'FuzzOrge',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:772,nome:'Drv04',cat:'drive',tap:null,enabled:false},{slot:2,id:1041,nome:'Tangerine',cat:'amp',tap:null,enabled:false},{slot:3,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:false},{slot:4,id:10498,nome:'Room',cat:'reverb',tap:null,enabled:false}],ts:0},
  'J1':{nome:'OCTAVEMS',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1551,nome:'Mod0F',cat:'mod',tap:'Rate',enabled:false},{slot:2,id:1041,nome:'Tangerine',cat:'amp',tap:null,enabled:false},{slot:3,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:false},{slot:4,id:2307,nome:'EarlyRef',cat:'reverb',tap:null,enabled:false}],ts:0},
  'J2':{nome:'REVERSH',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:10355,nome:'Dly73b',cat:'delay',tap:'Time',enabled:false},{slot:2,id:1031,nome:'Matchless',cat:'amp',tap:null,enabled:false},{slot:3,id:2306,nome:'Plate',cat:'reverb',tap:null,enabled:false}],ts:0},
  'J3':{nome:'Guitor',volume:110,temTime:false,temRate:false,efeitos:[{slot:1,id:1024,nome:'Amp00',cat:'amp',tap:null,enabled:false},{slot:2,id:1807,nome:'Spc0F',cat:'special',tap:null,enabled:false},{slot:3,id:10498,nome:'Room',cat:'reverb',tap:null,enabled:false}],ts:0},
  'J4':{nome:'PHASE Y',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1537,nome:'HPS',cat:'pitch',tap:null,enabled:false},{slot:2,id:1045,nome:'BGNDrive',cat:'amp',tap:null,enabled:true},{slot:3,id:8448,nome:'Dyn00b',cat:'dynamics',tap:null,enabled:false},{slot:4,id:2306,nome:'Plate',cat:'reverb',tap:null,enabled:false}],ts:0},
  'J5':{nome:'MS FLAG',volume:100,temTime:false,temRate:true,efeitos:[{slot:1,id:9739,nome:'Flanger',cat:'mod',tap:'Rate',enabled:true},{slot:2,id:9235,nome:'Amp13b',cat:'amp',tap:null,enabled:false},{slot:3,id:8449,nome:'OptComp',cat:'dynamics',tap:null,enabled:false},{slot:4,id:10498,nome:'Hall',cat:'reverb',tap:null,enabled:false}],ts:0},
  'J6':{nome:'DZ HEAY',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:9226,nome:'Amp0Ab',cat:'amp',tap:null,enabled:true},{slot:2,id:257,nome:'Comp',cat:'dynamics',tap:null,enabled:false},{slot:3,id:2306,nome:'Plate',cat:'reverb',tap:null,enabled:false}],ts:0},
  'J7':{nome:'LA LEA',volume:90,temTime:false,temRate:false,efeitos:[{slot:1,id:8980,nome:'Drv14b',cat:'drive',tap:null,enabled:true},{slot:2,id:9234,nome:'Amp12b',cat:'amp',tap:null,enabled:true},{slot:3,id:8710,nome:'Flt06b',cat:'filter',tap:null,enabled:false},{slot:4,id:10251,nome:'Delay',cat:'delay',tap:'Time',enabled:false},{slot:5,id:10500,nome:'TiledRoom',cat:'reverb',tap:null,enabled:false}],ts:0},
  'J8':{nome:'7strBo',volume:63,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'ZNR',cat:'dynamics',tap:null,enabled:false},{slot:2,id:514,nome:'ParaEQ',cat:'filter',tap:null,enabled:false},{slot:3,id:1035,nome:'Amp0B',cat:'amp',tap:null,enabled:false}],ts:0},
  'J9':{nome:'Power ea',volume:56,temTime:false,temRate:false,efeitos:[{slot:1,id:258,nome:'Dyn02',cat:'dynamics',tap:null,enabled:false},{slot:2,id:9229,nome:'TWRock',cat:'amp',tap:null,enabled:false},{slot:3,id:10499,nome:'Rvb03b',cat:'reverb',tap:null,enabled:false}],ts:0},
};
