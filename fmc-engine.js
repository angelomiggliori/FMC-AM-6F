...
// ══════════════════════════════════════════════════════════════════
const ZOOM_FX_DB = {
  // IDs confirmados pelos dumps reais fw 1.21 (E0-E9 anotados + fulldump A0-J9)
  // id2 = (raw[0]<<7)|raw[1]  ← 2 bytes  |  raw[2] = byte MSBs dos params (não é ID)
  // ─── Estruturais ────────────────────────────────────────────────
  0x2100:({n:'AmpSim',   c:'amp',      t:null}),
  0x2102:({n:'AmpSim-B', c:'amp',      t:null}),
  0x0201:({n:'AmpSim-C', c:'amp',      t:null}),
  0x0600:({n:'AmpSim-D', c:'amp',      t:null}),
  0x22C8:({n:'Cab-A',    c:'cab',      t:null}),
  0x2002:({n:'Cab-BC',   c:'cab',      t:null}),
  0x2A48:({n:'Cab-D',    c:'cab',      t:null}),
  0x0888:({n:'Cab-Bass', c:'cab',      t:null}),
  0x0004:({n:'ZNR',      c:'dynamics', t:null}),
  0x0008:({n:'GraphicEQ',c:'filter',   t:null}),
  0x000C:({n:'Cry',      c:'filter',   t:null}),   // mesmo ID que Ensemble/StereCho — raw[2] diferencia
  0x0010:({n:'Delay',    c:'delay',    t:'Time'}),  // mesmo ID que ReverseDL/StompDly — raw[2] diferencia
  0x0012:({n:'TS Drive', c:'drive',    t:null}),
  0x087D:({n:'Empty',    c:'empty',    t:null}),
  // ─── Pitch ──────────────────────────────────────────────────────
  ...
  // ─── Modulação (Rate) ───────────────────────────────────────────
  0x060A:({n:'BendChorus',c:'mod',     t:'Time'}),
  0x0480:({n:'Chorus',   c:'mod',      t:'Rate'}),
  0x0200:({n:'CoronaTri',c:'mod',      t:'Rate'}),
  0x208C:({n:'DuoPhase', c:'mod',      t:'Rate'}),
  0x000C:({n:'Ensemble', c:'mod',      t:'Rate'}),  // nota: raw[2] diferencia de Cry/StereCho
  0x1080:({n:'Flanger',  c:'mod',      t:'Rate'}),
  0x214C:({n:'Flanger',  c:'mod',      t:'Rate'}),
  0x004C:({n:'Phaser',   c:'mod',      t:'Rate'}),  // raw[2]=2→Phaser, raw[2]=11→VinFLNGR
  0x0080:({n:'fCycle',   c:'mod',      t:'Rate'}),
  0x1400:({n:'SuperCho', c:'mod',      t:'Rate'}),  // nota: raw[2]=12→SuperCho, raw[2]=18→ModReverb
  0x0000:({n:'TheVibe',  c:'mod',      t:'Rate'}),
  0x0614:({n:'Tremolo',  c:'mod',      t:'Rate'}),
  0x0180:({n:'Tremolo',  c:'mod',      t:'Rate'}),
  ...
  0x1480:({n:'UNK_1480', c:'unknown',  t:null}),
  0x0400:({n:'UNK_0400', c:'unknown',  t:null}),
  // ─── Reverb ─────────────────────────────────────────────────────
  0x2904:({n:'Air',      c:'reverb',   t:null}),
  0x2092:({n:'Arena',    c:'reverb',   t:null}),
  0x0000:({n:'EarlyRef', c:'reverb',   t:null}),  // raw[2]=18→EarlyRef, raw[2]=76→TheVibe
  ...
  0x0080:({n:'Room',     c:'reverb',   t:null}),  // raw[2]=82→Room, raw[2]=68→fCycle
  0x2908:({n:'Spring63', c:'reverb',   t:null}),
  0x0000:({n:'TiledRoom',c:'reverb',   t:null}),
};

// Seed cache: 36 patches reais coletados do full dump (fw 1.21)
const PATCH_CACHE_SEED = {
  'A0':{nome:'Dotted135',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:8904,nome:'Cab-A',cat:'cab',tap:null,enabled:true},{slot:3,id:4,nome:'ZNR',cat:'dynamics',tap:null,enabled:true},{slot:4,id:128,nome:'UNK-0080',cat:'unknown',tap:null,enabled:false},{slot:5,id:128,nome:'UNK-0080',cat:'unknown',tap:null,enabled:false}],ts:0},
  'A1':{nome:'Clean ae',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:8904,nome:'Cab-A',cat:'cab',tap:null,enabled:true},{slot:3,id:4,nome:'ZNR',cat:'dynamics',tap:null,enabled:true},{slot:4,id:6272,nome:'UNK-1880',cat:'unknown',tap:null,enabled:false},{slot:5,id:128,nome:'UNK-0080',cat:'unknown',tap:null,enabled:false}],ts:0},
  'A2':{nome:'Delay 5',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:8904,nome:'Cab-A',cat:'cab',tap:null,enabled:true},{slot:3,id:4,nome:'ZNR',cat:'dynamics',tap:null,enabled:true},{slot:4,id:6272,nome:'UNK-1880',cat:'unknown',tap:null,enabled:false},{slot:5,id:128,nome:'UNK-0080',cat:'unknown',tap:null,enabled:false}],ts:0},
  'A3':{nome:'Clean ae',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:8904,nome:'Cab-A',cat:'cab',tap:null,enabled:true},{slot:3,id:4,nome:'ZNR',cat:'dynamics',tap:null,enabled:true},{slot:4,id:5248,nome:'UNK-1480',cat:'unknown',tap:null,enabled:false}],ts:0},
  'A4':{nome:'Phaser',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:8904,nome:'Cab-A',cat:'cab',tap:null,enabled:true},{slot:3,id:4,nome:'ZNR',cat:'dynamics',tap:null,enabled:true},{slot:4,id:4096,nome:'UNK-1000',cat:'unknown',tap:null,enabled:false},{slot:5,id:128,nome:'UNK-0080',cat:'unknown',tap:null,enabled:false}],ts:0},
  'A5':{nome:'Clean ae',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:8904,nome:'Cab-A',cat:'cab',tap:null,enabled:true},{slot:3,id:4,nome:'ZNR',cat:'dynamics',tap:null,enabled:true},{slot:4,id:5248,nome:'UNK-1480',cat:'unknown',tap:null,enabled:false}],ts:0},
  'A6':{nome:'Tremol',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:8904,nome:'Cab-A',cat:'cab',tap:null,enabled:true},{slot:3,id:4,nome:'ZNR',cat:'dynamics',tap:null,enabled:true},{slot:4,id:384,nome:'UNK-0180',cat:'unknown',tap:null,enabled:false},{slot:5,id:128,nome:'UNK-0080',cat:'unknown',tap:null,enabled:false}],ts:0},
  'A7':{nome:'Violao',volume:0,temTime:false,temRate:false,efeitos:[],ts:0},
  'A8':{nome:'Bass',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1536,nome:'AmpSim-Bass',cat:'amp',tap:null,enabled:false},{slot:2,id:2184,nome:'Cab-Bass',cat:'cab',tap:null,enabled:false}],ts:0},
  'B0':{nome:'Dotted135',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'AmpSim-B',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:false},{slot:3,id:8,nome:'GraphicEQ',cat:'filter',tap:null,enabled:true},{slot:4,id:128,nome:'UNK-0080',cat:'unknown',tap:null,enabled:false}],ts:0},
  'B1':{nome:'Clean ae',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'AmpSim-B',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:false},{slot:3,id:8,nome:'GraphicEQ',cat:'filter',tap:null,enabled:true}],ts:0},
  'B2':{nome:'Delay 5',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'AmpSim-B',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:false},{slot:3,id:8,nome:'GraphicEQ',cat:'filter',tap:null,enabled:true},{slot:4,id:4224,nome:'UNK-1080',cat:'unknown',tap:null,enabled:false}],ts:0},
  'B3':{nome:'Clean ae',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'AmpSim-B',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:false},{slot:3,id:8,nome:'GraphicEQ',cat:'filter',tap:null,enabled:true}],ts:0},
  'B4':{nome:'Phaser',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'AmpSim-B',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:false},{slot:3,id:8,nome:'GraphicEQ',cat:'filter',tap:null,enabled:true},{slot:4,id:4096,nome:'UNK-1000',cat:'unknown',tap:null,enabled:false}],ts:0},
  'B5':{nome:'Clean ae',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'AmpSim-B',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:false},{slot:3,id:8,nome:'GraphicEQ',cat:'filter',tap:null,enabled:true}],ts:0},
  'B6':{nome:'Tremol',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'AmpSim-B',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:false},{slot:3,id:8,nome:'GraphicEQ',cat:'filter',tap:null,enabled:true},{slot:4,id:384,nome:'UNK-0180',cat:'unknown',tap:null,enabled:false}],ts:0},
  'B7':{nome:'Violao',volume:0,temTime:false,temRate:false,efeitos:[],ts:0},
  'B8':{nome:'Bass',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1536,nome:'AmpSim-Bass',cat:'amp',tap:null,enabled:false},{slot:2,id:2184,nome:'Cab-Bass',cat:'cab',tap:null,enabled:false}],ts:0},
  'C0':{nome:'Dotted135',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:513,nome:'AmpSim-C',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:true},{slot:3,id:16,nome:'OverDrive',cat:'drive',tap:null,enabled:true},{slot:4,id:4096,nome:'UNK-1000',cat:'unknown',tap:null,enabled:false}],ts:0},
  'C1':{nome:'Clean ae',volume:0,temTime:true,temRate:false,efeitos:[{slot:1,id:513,nome:'AmpSim-C',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:true},{slot:3,id:82,nome:'TapeEcho',cat:'delay',tap:'Time',enabled:true}],ts:0},
  'C2':{nome:'Delay 5',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:513,nome:'AmpSim-C',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:true},{slot:3,id:80,nome:'Delay',cat:'delay',tap:'Time',enabled:false},{slot:4,id:4096,nome:'UNK-1000',cat:'unknown',tap:null,enabled:false}],ts:0},
  'C3':{nome:'Clean ae',volume:0,temTime:true,temRate:false,efeitos:[{slot:1,id:513,nome:'AmpSim-C',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:true},{slot:3,id:82,nome:'TapeEcho',cat:'delay',tap:'Time',enabled:true}],ts:0},
  'C4':{nome:'Phaser',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:513,nome:'AmpSim-C',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:true},{slot:3,id:76,nome:'UNK-004C',cat:'unknown',tap:null,enabled:false},{slot:4,id:4096,nome:'UNK-1000',cat:'unknown',tap:null,enabled:false}],ts:0},
  'C5':{nome:'Clean ae',volume:0,temTime:true,temRate:false,efeitos:[{slot:1,id:513,nome:'AmpSim-C',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:true},{slot:3,id:82,nome:'TapeEcho',cat:'delay',tap:'Time',enabled:true}],ts:0},
  'C6':{nome:'Tremol',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:513,nome:'AmpSim-C',cat:'amp',tap:null,enabled:false},{slot:2,id:8194,nome:'Cab-BC',cat:'cab',tap:null,enabled:true},{slot:3,id:12,nome:'Cry',cat:'filter',tap:null,enabled:true},{slot:4,id:4096,nome:'UNK-1000',cat:'unknown',tap:null,enabled:false}],ts:0},
  'C7':{nome:'Violao',volume:0,temTime:false,temRate:false,efeitos:[],ts:0},
  'C8':{nome:'Bass',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1536,nome:'AmpSim-Bass',cat:'amp',tap:null,enabled:false},{slot:2,id:2184,nome:'Cab-Bass',cat:'cab',tap:null,enabled:false}],ts:0},
  'D0':{nome:'VOX JMDtd',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:10824,nome:'Cab-D',cat:'cab',tap:null,enabled:false},{slot:3,id:16,nome:'OverDrive',cat:'drive',tap:null,enabled:true}],ts:0},
  'D1':{nome:'VOX JMCln',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:10824,nome:'Cab-D',cat:'cab',tap:null,enabled:false},{slot:3,id:82,nome:'TapeEcho',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'D2':{nome:'VOX Dl135',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:10824,nome:'Cab-D',cat:'cab',tap:null,enabled:false},{slot:3,id:80,nome:'Delay',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'D3':{nome:'VOX JMCln',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:10824,nome:'Cab-D',cat:'cab',tap:null,enabled:false},{slot:3,id:82,nome:'TapeEcho',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'D4':{nome:'VOX Flg',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:10824,nome:'Cab-D',cat:'cab',tap:null,enabled:false},{slot:3,id:12,nome:'Cry',cat:'filter',tap:null,enabled:false},{slot:4,id:1024,nome:'Flanger',cat:'unknown',tap:null,enabled:false}],ts:0},
  'D5':{nome:'VOX JMCln',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:10824,nome:'Cab-D',cat:'cab',tap:null,enabled:false},{slot:3,id:82,nome:'TapeEcho',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'D6':{nome:'VOX Tr',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:8448,nome:'AmpSim-A',cat:'amp',tap:null,enabled:false},{slot:2,id:10824,nome:'Cab-D',cat:'cab',tap:null,enabled:false},{slot:3,id:12,nome:'Cry',cat:'filter',tap:null,enabled:false}],ts:0},
  'D7':{nome:'Violao',volume:0,temTime:false,temRate:false,efeitos:[],ts:0},
  'D8':{nome:'Bass',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1536,nome:'AmpSim-Bass',cat:'amp',tap:null,enabled:false},{slot:2,id:2184,nome:'Cab-Bass',cat:'cab',tap:null,enabled:false}],ts:0}
};
...
function limparCachePatches(){
  // Apaga as 3 camadas de cache de patches e recomeça do seed
  ...
  // Força dump do patch atual para atualizar com dados reais
  if(midiOut&&midiReady) setTimeout(requisitarDump, 200);
...
function parseZoomDump(data){
  ...
  for(let i=0;i<5;i++){
    ...
    // r0 bit0 = enabled flag (não faz parte do ID)
...
// ══════════════════════════════════════════════════════════════════
const TAP_PARAM_MAP = {
  // ✅ = confirmado por dump real (fw 1.21, E0-E9 anotados)
  // FÓRMULA: val = round((60000/bpm) / escala)  para tipo:'ms'
  //          val = round(bpm/60 × escala)         para tipo:'hz'
  // rawIdx = índice absoluto no rawSlot[]
  //
  // ─── Delays (Time) ──────────────────────────────────────────────
  0x1C00:({raw:6, tipo:'ms', escala:7.143}),    // Delay     ✅ E5 560ms→70  (500/7.143=70)
  0x1880:({raw:6, tipo:'ms', escala:8.929}),    // TapeEcho  ✅ E9 560ms→56  (500/8.929=56)
  0x280B:({raw:6, tipo:'ms', escala:7.143}),    // Delay     ✅ J0 confirmado
  0x287C:({raw:6, tipo:'ms', escala:7.813}),    // FilterDly ✅ E6 500ms→64
  0x286D:({raw:6, tipo:'ms', escala:7.813}),    // MultiTapD ✅ E7 3000ms→64 (500/7.813=64)
  0x2816:({raw:7, tipo:'ms', escala:50.0}),     // PitchDly  ✅ E8 90ms→10  (500/50=10)
  0x0010:({raw:6, tipo:'ms', escala:10.0}),     // ReverseDL/StompDly ✅ usa raw[2] p/ distinguir
  0x0990:({raw:6, tipo:'ms', escala:5.208}),    // StereoDly ✅ E9 165ms→96 (500/5.208=96)
  0x0050:({raw:6, tipo:'ms', escala:7.143}),    // CarbonDly ⚠ raw[6]=69 (a confirmar)
  // ─── Modulações (Rate) ──────────────────────────────────────────
  0x0480:({raw:6, tipo:'hz', escala:25.0}),     // Chorus    ✅ E0 rate25→val50
  0x1080:({raw:4, tipo:'hz', escala:28.0}),     // Flanger   ✅ E1 rate7→val56 (2×28=56→÷8=7) 
  0x214C:({raw:4, tipo:'hz', escala:28.0}),     // Flanger   ✅ J0
  0x004C:({raw:3, tipo:'hz', escala:12.0}),     // Phaser/VinFLNGR ✅ E2 rate12→val24 (2×12=24)
  0x1400:({raw:6, tipo:'hz', escala:25.0}),     // SuperCho  ✅ E3 rate50→val50 (usa raw[2] p/ ModReverb)
  0x0000:({raw:3, tipo:'hz', escala:3.0}),      // TheVibe/TiledRoom ⚠ raw[3]=6, speed=25 (2×3=6)
  0x0614:({raw:2, tipo:'hz', escala:4.0}),      // Tremolo   ✅ E4 rate33→val8 (2×4=8)
  0x0180:({raw:2, tipo:'hz', escala:4.0}),      // Tremolo   ✅ J0
  0x090C:({raw:9, tipo:'hz', escala:7.5}),      // Vibrato   ✅ E4 rate30→val15 (2×7.5=15)
  0x0080:({raw:9, tipo:'hz', escala:6.0}),      // fCycle    ✅ E4 rate6→val12 (2×6=12)
  0x000C:({raw:6, tipo:'hz', escala:15.0}),     // Ensemble/StereCho ⚠ raw[6]=60≈rate29×2 (2×15=30)
  0x208C:({raw:3, tipo:'hz', escala:20.0}),     // DuoPhase  ⚠ raw[3]=40, RateA=47 (2×20=40≈47)
  0x0200:({raw:3, tipo:'hz', escala:3.0}),      // CoronaTri ⚠ raw[3]=6, speed=25 (2×3=6)
};
