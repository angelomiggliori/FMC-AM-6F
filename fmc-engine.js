// FMC-AM 6F · Motor v4.2 — fmc-engine.js — build: v4.2-b20260316-db3final
...
const PATCH_CACHE_SEED = {
  'A0':{nome:'Graphi',volume:12,temTime:false,temRate:false,efeitos:[{slot:1,id:515,nome:'GraphicEQ',cat:'filter',tap:null,enabled:false}],ts:0},
  'A1':{nome:'ParaEQ',volume:12,temTime:false,temRate:false,efeitos:[{slot:1,id:514,nome:'ParaEQ',cat:'filter',tap:null,enabled:false}],ts:0},
  'A2':{nome:'160 Co',volume:6,temTime:false,temRate:false,efeitos:[{slot:1,id:265,nome:'160Comp',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'A3':{nome:'AutoWa',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8708,nome:'AutoWah',cat:'filter',tap:null,enabled:false}],ts:0},
  'A4':{nome:'Comp',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:257,nome:'Comp',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'A5':{nome:'Cry',volume:16,temTime:false,temRate:false,efeitos:[{slot:1,id:513,nome:'Cry',cat:'filter',tap:null,enabled:false}],ts:0},
  'A6':{nome:'Excite',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:512,nome:'Exciter',cat:'filter',tap:null,enabled:false}],ts:0},
  'A7':{nome:'fCycle',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8705,nome:'fCycle',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'A8':{nome:'M-Filt',volume:7,temTime:false,temRate:false,efeitos:[{slot:1,id:526,nome:'MFilter',cat:'filter',tap:null,enabled:false}],ts:0},
  ...
  'B0':{nome:'OptCom 0',volume:50,temTime:false,temRate:false,efeitos:[{slot:1,id:8449,nome:'OptComp',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'B1':{nome:'RndmFLR',volume:6,temTime:false,temRate:false,efeitos:[{slot:1,id:520,nome:'RndmFltr',cat:'filter',tap:null,enabled:false}],ts:0},
  'B2':{nome:'SeqFLT',volume:25,temTime:false,temRate:false,efeitos:[{slot:1,id:513,nome:'SeqFilter',cat:'filter',tap:null,enabled:false}],ts:0},
  'B3':{nome:'SlowATCK',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:261,nome:'SlowAtck',cat:'filter',tap:null,enabled:false}],ts:0},
  'B4':{nome:'Step',volume:8,temTime:false,temRate:false,efeitos:[{slot:1,id:527,nome:'StepFltr',cat:'filter',tap:null,enabled:false}],ts:0},
  'B5':{nome:'ZNR    0',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:8450,nome:'ZNR',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'B6':{nome:'Aco.Si',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:788,nome:'Amp',cat:'amp',tap:null,enabled:false}],ts:0},
  'B7':{nome:'Booste',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:788,nome:'Amp',cat:'amp',tap:null,enabled:false}],ts:0},
  'B8':{nome:'Dist 1',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false}],ts:0},
  'B9':{nome:'Dist+',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:788,nome:'Amp',cat:'amp',tap:null,enabled:false}],ts:0},
  'C0':{nome:'ExtremS',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false}],ts:0},
  'C1':{nome:'FuzzSme',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:785,nome:'Fuzz',cat:'drive',tap:null,enabled:false}],ts:0},
  'C2':{nome:'Govern',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false}],ts:0},
  'C3':{nome:'GreatMf',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:785,nome:'Fuzz',cat:'drive',tap:null,enabled:false}],ts:0},
  'C4':{nome:'ALIEN',volume:87,temTime:false,temRate:false,efeitos:[{slot:1,id:1039,nome:'ALIEN',cat:'amp',tap:null,enabled:false}],ts:0},
  'C5':{nome:'HotBox',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false}],ts:0},
  'C6':{nome:'Lead',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false}],ts:0},
  'C7':{nome:'MetalWL',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false}],ts:0},
  'C8':{nome:'OverDre',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false}],ts:0},
  'C9':{nome:'Squeak',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:778,nome:'Squeak',cat:'drive',tap:null,enabled:false}],ts:0},
  'D0':{nome:'T Scre',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:785,nome:'Fuzz',cat:'drive',tap:null,enabled:false}],ts:0},
  'D1':{nome:'Z Clea',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false}],ts:0},
  'D2':{nome:'Z MP1',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false}],ts:0},
  'D3':{nome:'Z Scre',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false}],ts:0},
  'D4':{nome:'Z Wild',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:783,nome:'Drive',cat:'drive',tap:null,enabled:false}],ts:0},
  'D5':{nome:'B-BREA',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:9231,nome:'BlackBrth',cat:'amp',tap:null,enabled:false}],ts:0},
  'D6':{nome:'BG CRUC',volume:99,temTime:false,temRate:false,efeitos:[{slot:1,id:9230,nome:'BGCrunch',cat:'amp',tap:null,enabled:false}],ts:0},
  'D7':{nome:'BG DRIE',volume:97,temTime:false,temRate:false,efeitos:[{slot:1,id:9227,nome:'BGDrive',cat:'amp',tap:null,enabled:false}],ts:0},
  'D8':{nome:'BGN DRE',volume:91,temTime:false,temRate:false,efeitos:[{slot:1,id:1045,nome:'BGNDrive',cat:'amp',tap:null,enabled:false}],ts:0},
  'D9':{nome:'CAR DRE',volume:74,temTime:false,temRate:false,efeitos:[{slot:1,id:9228,nome:'CARDrive',cat:'amp',tap:null,enabled:false}],ts:0},
  'E0':{nome:'DELUXE',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1036,nome:'Deluxe',cat:'amp',tap:null,enabled:false}],ts:0},
  'E1':{nome:'DZ DRIE',volume:93,temTime:false,temRate:false,efeitos:[{slot:1,id:9227,nome:'BGDrive',cat:'amp',tap:null,enabled:false}],ts:0},
  'E2':{nome:'FD COMO',volume:86,temTime:false,temRate:false,efeitos:[{slot:1,id:1030,nome:'FDCombo',cat:'amp',tap:null,enabled:false}],ts:0},
  'E3':{nome:'FD VIBO',volume:98,temTime:false,temRate:false,efeitos:[{slot:1,id:1038,nome:'FDVibro',cat:'amp',tap:null,enabled:false}],ts:0},
  'E4':{nome:'HW STA',volume:106,temTime:false,temRate:false,efeitos:[{slot:1,id:1037,nome:'HWStar',cat:'amp',tap:null,enabled:false}],ts:0},
  'E5':{nome:'MS 195',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1038,nome:'FDVibro',cat:'amp',tap:null,enabled:false}],ts:0},
  'E6':{nome:'MATCH',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1031,nome:'Matchless',cat:'amp',tap:null,enabled:false}],ts:0},
  'E7':{nome:'MS CRUC',volume:98,temTime:false,temRate:false,efeitos:[{slot:1,id:1042,nome:'MSCrunch',cat:'amp',tap:null,enabled:false}],ts:0},
  'E8':{nome:'MS DRIE',volume:103,temTime:false,temRate:false,efeitos:[{slot:1,id:1044,nome:'MSDrive',cat:'amp',tap:null,enabled:false}],ts:0},
  'E9':{nome:'REVO-1',volume:89,temTime:false,temRate:false,efeitos:[{slot:1,id:1040,nome:'REVO1',cat:'amp',tap:null,enabled:false}],ts:0},
  'F0':{nome:'TANGERE',volume:99,temTime:false,temRate:false,efeitos:[{slot:1,id:1041,nome:'Tangerine',cat:'amp',tap:null,enabled:false}],ts:0},
  'F1':{nome:'TONE CY',volume:89,temTime:false,temRate:false,efeitos:[{slot:1,id:1043,nome:'ToneCycle',cat:'amp',tap:null,enabled:false}],ts:0},
  'F2':{nome:'TW ROC',volume:95,temTime:false,temRate:false,efeitos:[{slot:1,id:9229,nome:'TWRock',cat:'amp',tap:null,enabled:false}],ts:0},
  'F3':{nome:'US BLU',volume:107,temTime:false,temRate:false,efeitos:[{slot:1,id:9230,nome:'BGCrunch',cat:'amp',tap:null,enabled:false}],ts:0},
  'F4':{nome:'VX COMO',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:9223,nome:'VXCombo',cat:'amp',tap:null,enabled:false}],ts:0},
  'F5':{nome:'VX JMI',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1036,nome:'Deluxe',cat:'amp',tap:null,enabled:false}],ts:0},
  'F6':{nome:'BendCh',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1546,nome:'BendChorus',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'F7':{nome:'BitCru',volume:90,temTime:false,temRate:false,efeitos:[{slot:1,id:9985,nome:'BitCrush',cat:'special',tap:null,enabled:false}],ts:0},
  'F8':{nome:'Bomber 0',volume:15,temTime:false,temRate:false,efeitos:[{slot:1,id:9984,nome:'Bomber',cat:'special',tap:null,enabled:false}],ts:0},
  'F9':{nome:'Chorus',volume:50,temTime:false,temRate:false,efeitos:[{slot:1,id:1546,nome:'Chorus',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'G0':{nome:'Coronari',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:9734,nome:'CoronaRing',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'G1':{nome:'Detune',volume:52,temTime:false,temRate:false,efeitos:[{slot:1,id:9736,nome:'Detune',cat:'pitch',tap:null,enabled:false}],ts:0},
  'G2':{nome:'DuoPha',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1547,nome:'DuoPhase',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'G3':{nome:'Ensembe',volume:60,temTime:false,temRate:false,efeitos:[{slot:1,id:1546,nome:'Ensemble',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'G4':{nome:'Flange',volume:18,temTime:false,temRate:false,efeitos:[{slot:1,id:9739,nome:'Flanger',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'G5':{nome:'HPS    h',volume:70,temTime:false,temRate:false,efeitos:[{slot:1,id:1537,nome:'HPS',cat:'pitch',tap:null,enabled:false}],ts:0},
  'G6':{nome:'MonoPich',volume:50,temTime:false,temRate:false,efeitos:[{slot:1,id:1536,nome:'MonoPitch',cat:'pitch',tap:null,enabled:false}],ts:0},
  'G7':{nome:'Octave h',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1556,nome:'Octave',cat:'pitch',tap:null,enabled:false}],ts:0},
  'G8':{nome:'Phaser',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:9730,nome:'Phaser',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'G9':{nome:'PitchSFT',volume:40,temTime:false,temRate:false,efeitos:[{slot:1,id:9732,nome:'PitchSHFT',cat:'pitch',tap:null,enabled:false}],ts:0},
  'H0':{nome:'RingMo',volume:50,temTime:false,temRate:false,efeitos:[{slot:1,id:9734,nome:'RingMod',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'H1':{nome:'Rt Clo',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1804,nome:'RtCloset',cat:'special',tap:null,enabled:false}],ts:0},
  'H2':{nome:'Slicer',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:1536,nome:'Slicer',cat:'special',tap:null,enabled:false}],ts:0},
  'H3':{nome:'Stereo',volume:60,temTime:false,temRate:false,efeitos:[{slot:1,id:1556,nome:'StereCho',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'H4':{nome:'SuperCo',volume:50,temTime:false,temRate:false,efeitos:[{slot:1,id:1548,nome:'SuperCho',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'H5':{nome:'TheVib',volume:48,temTime:false,temRate:false,efeitos:[{slot:1,id:9734,nome:'TheVibe',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'H6':{nome:'Tremol',volume:2,temTime:false,temRate:false,efeitos:[{slot:1,id:1556,nome:'Tremolo',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'H7':{nome:'VinFLN',volume:18,temTime:false,temRate:false,efeitos:[{slot:1,id:9739,nome:'Flanger',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'H8':{nome:'Vibrat',volume:72,temTime:false,temRate:false,efeitos:[{slot:1,id:1546,nome:'Vibrato',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'H9':{nome:'Z-Orga',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:1809,nome:'Z-Organ',cat:'special',tap:null,enabled:false}],ts:0},
  'I0':{nome:'Air    0',volume:60,temTime:false,temRate:false,efeitos:[{slot:1,id:10500,nome:'Air',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I1':{nome:'Arena',volume:56,temTime:false,temRate:false,efeitos:[{slot:1,id:2307,nome:'Arena',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I2':{nome:'Carbonly',volume:69,temTime:false,temRate:false,efeitos:[{slot:1,id:10336,nome:'CarbonDly',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'I3':{nome:'Delay',volume:70,temTime:false,temRate:false,efeitos:[{slot:1,id:10251,nome:'Delay',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'I4':{nome:'EarlyR',volume:50,temTime:false,temRate:false,efeitos:[{slot:1,id:2307,nome:'EarlyRef',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I5':{nome:'Filterly',volume:90,temTime:false,temRate:false,efeitos:[{slot:1,id:10364,nome:'FilterDly',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'I6':{nome:'Hall',volume:46,temTime:false,temRate:false,efeitos:[{slot:1,id:10498,nome:'Hall',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I7':{nome:'HD Hal P',volume:62,temTime:false,temRate:false,efeitos:[{slot:1,id:2324,nome:'HDHall',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I8':{nome:'ModRevb',volume:45,temTime:false,temRate:false,efeitos:[{slot:1,id:2313,nome:'ModReverb',cat:'reverb',tap:'Rate',enabled:false}],ts:0},
  'I9':{nome:'MultiTD',volume:20,temTime:false,temRate:false,efeitos:[{slot:1,id:10349,nome:'MultiTapD',cat:'delay',tap:'Time',enabled:false}],ts:0},
  ...
  'J1':{nome:'PitchDy',volume:80,temTime:false,temRate:false,efeitos:[{slot:1,id:10262,nome:'PitchDly',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'J2':{nome:'Plate',volume:44,temTime:false,temRate:false,efeitos:[{slot:1,id:2306,nome:'Plate',cat:'reverb',tap:null,enabled:false}],ts:0},
  'J3':{nome:'ReversL',volume:50,temTime:false,temRate:false,efeitos:[{slot:1,id:2167,nome:'ReverseDL',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'J4':{nome:'Room   P',volume:60,temTime:false,temRate:false,efeitos:[{slot:1,id:10498,nome:'Room',cat:'reverb',tap:null,enabled:false}],ts:0},
  'J5':{nome:'Spring3',volume:58,temTime:false,temRate:false,efeitos:[{slot:1,id:10504,nome:'Spring63',cat:'reverb',tap:null,enabled:false}],ts:0},
  'J6':{nome:'Stereoly',volume:100,temTime:false,temRate:false,efeitos:[{slot:1,id:2089,nome:'StereoDly',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'J7':{nome:'-      @',volume:103,temTime:false,temRate:false,efeitos:[{slot:1,id:2055,nome:'StompDly',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'J8':{nome:'StompDy',volume:103,temTime:false,temRate:false,efeitos:[{slot:1,id:2055,nome:'StompDly',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'J9':{nome:'TiledR',volume:46,temTime:false,temRate:false,efeitos:[{slot:1,id:10500,nome:'TiledRoom',cat:'reverb',tap:null,enabled:false}],ts:0},
};
...
function parseZoomDump(data){
  ...
  for(let i=0;i<5;i++){
    ...
    // SHARED: módulos com múltiplos presets — raw[2] discrimina o preset
    // Fonte: dump3 fw 1.21 (100 patches nome=efeito, confirmado)
    const r2 = data[off+2];
    const SHARED = {
      // Dynamics/Filter
      ...
      // Modulações (mesmo módulo DSP, presets diferentes)
      ...
      // Reverb (mesmo módulo, salas diferentes)
    ...
    if(SHARED[id2]){
      ...
      // Busca pelo valor exato de r2, senão usa a primeira string encontrada como default
