...
const FS_IDX_BANK = FS_MODE === 12 ?  5 : 5;  // idx 5 = BANK top-right (modo 12: [0-4]=patches, [5]=BANK, [6-10]=patches, [11]=TAP)
const FS_IDX_TUNER= FS_MODE === 12 ?  5 : 2;  // hold no BANK = Tuner
