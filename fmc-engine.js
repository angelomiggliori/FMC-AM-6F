// FMC-AM 6F · Motor v4.2 — fmc-engine.js — build: v4.2-b20260316-final
...
const PATCH_CACHE_SEED = {
  ...
  'A2':{nome:'160 Co',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:265,nome:'160Comp',cat:'dynamics',tap:null,enabled:false}],ts:0},
  ...
  'A4':{nome:'Comp',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:257,nome:'Comp',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'A5':{nome:'Cry',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:513,nome:'Cry',cat:'filter',tap:null,enabled:false}],ts:0},
  ...
  'B0':{nome:'OptCom 0',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:8449,nome:'OptComp',cat:'dynamics',tap:null,enabled:false}],ts:0},
  'B1':{nome:'RndmFLR',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:520,nome:'RndmFltr',cat:'filter',tap:null,enabled:false}],ts:0},
  'B2':{nome:'SeqFLT',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:513,nome:'SeqFilter',cat:'filter',tap:null,enabled:false}],ts:0},
  ...
  'C1':{nome:'FuzzSme',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:785,nome:'Fuzz',cat:'drive',tap:null,enabled:false}],ts:0},
  ...
  'C3':{nome:'GreatMf',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:785,nome:'Fuzz',cat:'drive',tap:null,enabled:false}],ts:0},
  'C4':{nome:'ALIEN',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1039,nome:'ALIEN',cat:'amp',tap:null,enabled:false}],ts:0},
  ...
  'D0':{nome:'T Scre',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:785,nome:'Fuzz',cat:'drive',tap:null,enabled:false}],ts:0},
  ...
  'D7':{nome:'BG DRIE',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:9227,nome:'BGDrive',cat:'amp',tap:null,enabled:false}],ts:0},
  ...
  'D9':{nome:'CAR DRE',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:9228,nome:'CARDrive',cat:'amp',tap:null,enabled:false}],ts:0},
  'E0':{nome:'DELUXE',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1036,nome:'Deluxe',cat:'amp',tap:null,enabled:false}],ts:0},
  ...
  'E4':{nome:'HW STA',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1037,nome:'HWStar',cat:'amp',tap:null,enabled:false}],ts:0},
  'E5':{nome:'MS 195',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1038,nome:'FDVibro',cat:'amp',tap:null,enabled:false}],ts:0},
  ...
  'E8':{nome:'MS DRIE',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1044,nome:'MSDrive',cat:'amp',tap:null,enabled:false}],ts:0},
  ...
  'F0':{nome:'TANGERE',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1041,nome:'Tangerine',cat:'amp',tap:null,enabled:false}],ts:0},
  'F1':{nome:'TONE CY',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1043,nome:'ToneCycle',cat:'amp',tap:null,enabled:false}],ts:0},
  ...
  'F3':{nome:'US BLU',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:9230,nome:'BGCrunch',cat:'amp',tap:null,enabled:false}],ts:0},
  'F4':{nome:'VX COMO',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:9223,nome:'VXCombo',cat:'amp',tap:null,enabled:false}],ts:0},
  'F5':{nome:'VX JMI',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1036,nome:'Deluxe',cat:'amp',tap:null,enabled:false}],ts:0},
  ...
  'F8':{nome:'Bomber 0',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:9984,nome:'Bomber',cat:'special',tap:null,enabled:false}],ts:0},
  ...
  'G1':{nome:'Detune',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:9736,nome:'Detune',cat:'pitch',tap:null,enabled:false}],ts:0},
  'G2':{nome:'DuoPha',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1547,nome:'DuoPhase',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  ...
  'G4':{nome:'Flange',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:9739,nome:'Flanger',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'G5':{nome:'HPS    h',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1537,nome:'HPS',cat:'pitch',tap:null,enabled:false}],ts:0},
  ...
  'G8':{nome:'Phaser',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:9730,nome:'Phaser',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'G9':{nome:'PitchSFT',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:9732,nome:'PitchSHFT',cat:'pitch',tap:null,enabled:false}],ts:0},
  'H0':{nome:'RingMo',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:9734,nome:'RingMod',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  'H1':{nome:'Rt Clo',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1804,nome:'RtCloset',cat:'special',tap:null,enabled:false}],ts:0},
  ...
  'H4':{nome:'SuperCo',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1548,nome:'SuperCho',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  ...
  'H7':{nome:'VinFLN',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:9739,nome:'Flanger',cat:'mod',tap:'Rate',enabled:false}],ts:0},
  ...
  'H9':{nome:'Z-Orga',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:1809,nome:'Z-Organ',cat:'special',tap:null,enabled:false}],ts:0},
  'I0':{nome:'Air    0',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:10500,nome:'Air',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I1':{nome:'Arena',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:2307,nome:'Arena',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I2':{nome:'Carbonly',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:10336,nome:'CarbonDly',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'I3':{nome:'Delay',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:10251,nome:'Delay',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'I4':{nome:'EarlyR',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:2307,nome:'EarlyRef',cat:'reverb',tap:null,enabled:false}],ts:0},
  'I5':{nome:'Filterly',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:10364,nome:'FilterDly',cat:'delay',tap:'Time',enabled:false}],ts:0},
  ...
  'I8':{nome:'ModRevb',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:2313,nome:'ModReverb',cat:'reverb',tap:'Rate',enabled:false}],ts:0},
  'I9':{nome:'MultiTD',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:10349,nome:'MultiTapD',cat:'delay',tap:'Time',enabled:false}],ts:0},
  ...
  'J3':{nome:'ReversL',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:2167,nome:'ReverseDL',cat:'delay',tap:'Time',enabled:false}],ts:0},
  ...
  'J5':{nome:'Spring3',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:10504,nome:'Spring63',cat:'reverb',tap:null,enabled:false}],ts:0},
  ...
  'J7':{nome:'-      @',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:2055,nome:'StompDly',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'J8':{nome:'StompDy',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:2055,nome:'StompDly',cat:'delay',tap:'Time',enabled:false}],ts:0},
  'J9':{nome:'TiledR',volume:0,temTime:false,temRate:false,efeitos:[{slot:1,id:10500,nome:'TiledRoom',cat:'reverb',tap:null,enabled:false}],ts:0},
};
